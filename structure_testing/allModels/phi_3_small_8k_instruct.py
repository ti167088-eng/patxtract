"""
Phi-3-Small-8k-Instruct model implementation for structure extraction
"""
import sys
import os
import json
...
class Phi_3_Small_8K_Instruct(BaseModel):
    """Phi-3-Small-8k-Instruct model implementation via OpenRouter"""

    def __init__(self):
        """Initialize the Phi-3-Small-8k-Instruct model."""
        super().__init__(
            model_name="Phi-3_Small_8K_Instruct",
            model_id="microsoft/phi-3-small-8k-instruct"
        )
        self.api_url = f"{self.base_url}/chat/completions"
        self.logger.info("Phi-3-Small-8k-Instruct model initialized")

    def call_api(self, messages: List[Dict[str, str]], **kwargs) -> Dict[str, Any]:
        """
        Make API call to Phi-3-Small-8k-Instruct via OpenRouter.
    ...
    def extract_structure(self, content: str) -> Dict[str, Any]:
        """
        Extract structured data from Phi-3-Small-8k-Instruct response.
...
def main():
    """Main function to run the Phi-3-Small-8k-Instruct model"""
    try:
        extractor = Phi_3_Small_8K_Instruct()
